    ...
    <div class="col-lg-6 col-md-12">
      ...
      <div class="single-news mb-lg-0 mb-4">
        ...
        <div class="view overlay rounded z-depth-1-half mb-4">
          <img class="img-fluid w-100" src="http://via.placeholder.com/640x360" alt="Sample image">
          <a>
            <div class="mask rgba-white-slight"></div>
          </a>
        </div>
        ...
        <p class="grey-text mb-lg-0 mb-md-5 mb-4 ">Sed ut perspiciatis unde voluptatem omnis iste natus
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <div class="view overlay rounded z-depth-1 mb-4">
              <img class="img-fluid" src="http://via.placeholder.com/640x360" alt="Sample image">
              <a>
                <div class="mask rgba-white-slight"></div>
              </a>
            </div>
          ...
          <div class="col-md-9">
            ...
            <div class="d-flex justify-content-between">
              <div class="col-11 text-truncate pl-0 mb-3">
                <a href="#!" class="grey-text">At vero eos et accusamus et iusto odio dignissimos
      ...
      <div class="single-news mb-4">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <!--Image-->
            <div class="view overlay rounded z-depth-1 mb-4">
              <img class="img-fluid" src="http://via.placeholder.com/640x360"
                alt="Sample image">
              <a>
                <div class="mask rgba-white-slight"></div>
              </a>
          ...
          <div class="col-md-9">
            ...
            <div class="d-flex justify-content-between">
              <div class="col-11 text-truncate pl-0 mb-3">
                <a href="#!" class="grey-text">Itaque earum rerum hic tenetur a sapiente delectus</a>
              </div>
              <a><i class="fas fa-angle-double-right"></i></a>
            </div>
      ...
      <div class="single-news mb-4">
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <div class="d-flex justify-content-between">
              <div class="col-11 text-truncate pl-0 mb-3">
                <a href="#!" class="grey-text">Soluta nobis est eligendi optio cumque nihil impedit quo
                  minus</a>
              </div>
              <a><i class="fas fa-angle-double-right"></i></a>
            </div>
          ...
          <div class="col-md-9">
            ...
            <div class="d-flex justify-content-between">
              <div class="col-11 text-truncate pl-0 mb-lg-3">
                <a href="#!" class="grey-text">Duis aute irure dolor in reprehenderit in voluptate</a>
              </div>
              <a><i class="fas fa-angle-double-right"></i></a>
            </div>
